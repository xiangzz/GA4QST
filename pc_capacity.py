...
str = filename + '/' + 'capacity' + time_str
csv_name = str + '.csv'
...
if __name__ == '__main__':
    ...
    min_sum_capacity = len(serviceList) + 1
    min_capacity = math.ceil(min_sum_capacity / server_num)
    ...
    for i in range(0, 5):
        ...
        for d in deviceList:
            if isinstance(d, Server):
                d.capacity = min_capacity + i
                identifier = d.capacity
